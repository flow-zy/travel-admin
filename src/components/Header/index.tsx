  ...
  return (<Drawer
    ...
    footer={
      <Space className="footer">
        ...
        <Button type='default' onClick={() => setConfig({})}>重置</Button>
      </Space>
    }
  >
    <div className='theme pt-6 pb-6 flex justify-between'>
      ...
      <ColorPicker showText onChange={changeTheme} allowClear defaultValue='#1077ff' disabledAlpha />
    </div>
    <div className='theme pt-6 pb-6 flex justify-between'>
      <p className='title'>
          ...
          <div className="header-right flex justify-between items-center w-1/5">
            ...
            <Dropdown menu={{ items, onClick }}>
              <a onClick={(e) => { e.preventDefault() }}>
                <Space>
                  <Avatar src={userInfo.avatar ?? avatar} size={48} alt={userInfo.username ?? '头像'} />
                </Space>
              </a>
            </Dropdown>
          </div>
